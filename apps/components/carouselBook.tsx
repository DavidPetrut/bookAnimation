      ...
      page: (
        <div style={{ padding: "20px", height: "100%", overflow: "auto" }}>
          ...
          <p className="book-text" style={{ fontSize: "1.3vw" }}>
            ...
            миллионов человек и ВВП более 2 триллионов долларов.
            <span className="hide-on-super-small">
              Россия занимает одно из первых мест по добыче природных ресурсов,
              и сотрудничество с её рынком требует глубокого понимания языка.
